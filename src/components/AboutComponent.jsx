    ...
    render(){
      return (
        ...
        <div className = "container">
            ...
            <br></br>
             <h6>This app has been designed to be a very simple way for a user to track their medications. Right now it is a work in progress. Currently, a user can enter a medication including dosage, quantity, and additional notes the user might need to remember to tell their physician. The user can also delete a medication if they have accidentally added something they haven't taken. </h6> 
             <div className ="list">
